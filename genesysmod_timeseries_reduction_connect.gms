...
$ifi %switch_only_load_gdx%==0 $call gams genesysmod_gams_connect.gms --task="load_time" --in_file="%inputdir%%hourly_data_file%.xlsx"  --out_file="%gdxdir%%hourly_data_file%_elmod.gdx";
