...
map_techToCategory('HLR_Gas_Boiler','Residential') = Yes;
map_techToCategory('HLR_Gas_CHP','Power') = Yes;
map_techToCategory('HLR_Biomass','Residential') = Yes;
map_techToCategory('HLR_Biomass_CHP','Power') = Yes;
map_techToCategory('HLR_Hardcoal','Residential') = Yes;
map_techToCategory('HLR_Lignite','Residential') = Yes;
map_techToCategory('HLR_Hardcoal_CHP','Power') = Yes;
map_techToCategory('HLR_Lignite_CHP','Power') = Yes;
map_techToCategory('HLR_Direct_Electric','Residential') = Yes;
map_techToCategory('HLR_Solar_Thermal','Residential') = Yes;
map_techToCategory('HLR_Heatpump_Aerial','Residential') = Yes;
map_techToCategory('HLR_Heatpump_Ground','Residential') = Yes;
map_techToCategory('HLR_Geothermal','Residential') = Yes;
map_techToCategory('HLR_Oil_Boiler','Residential') = Yes;
map_techToCategory('HLR_H2_Boiler','Residential') = Yes;
...
map_techToCategory('RES_Grass','Resource') = Yes;
map_techToCategory('RES_Wood','Resource') = Yes;
map_techToCategory('RES_Residues','Resource') = Yes;
map_techToCategory('RES_Paper_Cardboard','Resource') = Yes;
map_techToCategory('RES_Roundwood','Resource') = Yes;
map_techToCategory('RES_Biogas','Resource') = Yes;
...
map_techToCategory('RES_Hydro_Dispatchable','Power') = Yes;
map_techToCategory('Res_Hydro_RoR','Power') = Yes;
...
map_techToCategory('RES_Wind_Onshore_Opt_H2','Power') = Yes;
map_techToCategory('RES_Wind_Offshore_Shallow_H2','Power') = Yes;
map_techToCategory('RES_PV_Utility_Opt_H2','Power') = Yes;
