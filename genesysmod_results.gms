...
output_emissions(r,'Regional Endogenous CO2 Price',e,'Regional Endogenous CO2 Price','Regional Endogenous CO2 Price','%emissionPathway%_%emissionScenario%',y)  = E8_RegionalAnnualEmissionsLimit.m(y,e,r);    
