...
TradeCapacity(r,rr,f,y) = Readin_TradeCapacity(r,rr,f,y);
TradeCosts(r,rr,f,y) = TradeCostFactor(f,y)*TradeRoute(r,rr,f,y);
CommissionedTradeCapacity(r,rr,f,y) = Readin_CommissionedTradeCapacity(r,rr,f,y);

GrowthRateTradeCapacity(r,rr,f,y) = Readin_GrowthRateTradeCapacity(r,rr,f,y);
TradeCapacityGrowthCosts(r,rr,f) = Readin_TradeCapacityGrowthCosts(r,rr,f);
